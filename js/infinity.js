...
addLayer("in", {
    ...
    bigCrunch()
    {
        ...
        if (inChallenge("ip", 11) && !hasChallenge("ip", 11) && player.points.gte(1e300))
        {
            completeChallenge("ip", 11)
        }
        if (inChallenge("ip", 12) && !hasChallenge("ip", 12) && player.points.gte(1e300))
        {
            completeChallenge("ip", 12)
        }
        if (inChallenge("ip", 13) && !hasChallenge("ip", 13) && player.points.gte(1e300))
        {
            completeChallenge("ip", 13)
        }
        if (inChallenge("ip", 14) && !hasChallenge("ip", 14) && player.points.gte(1e300))
        {
            completeChallenge("ip", 14)
        }
        if (inChallenge("ip", 15) && !hasChallenge("ip", 15) && player.points.gte(1e300))
        {
            completeChallenge("ip", 15)
        }
        if (inChallenge("ip", 16) && !hasChallenge("ip", 16) && player.points.gte(1e300))
        {
            completeChallenge("ip", 16)
        }
        if (inChallenge("ip", 18) && !hasChallenge("ip", 18) && player.points.gte(1e300))
        {
