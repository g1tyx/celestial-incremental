addLayer("cb", {
    ...
    startData() { return {
        ...
        buttonTimersMax: [new Decimal(60),new Decimal(180),new Decimal(300),new Decimal(5),new Decimal(1200),],
        buttonTimers: [new Decimal(0),new Decimal(0),new Decimal(0),new Decimal(0),new Decimal(0),],
        buttonBaseXP: [new Decimal(1),new Decimal(2),new Decimal(4),new Decimal(0.04),new Decimal(25),],
        ...
        rarePetUnlocks: [false],
        rarePetLevels: [new Decimal(0),],
        rarePetAmounts: [new Decimal(0),],
        rarePetReq: [new Decimal(1),],
        rarePetImage: ["<img src='resources/novaRarePet.png'style='width:calc(80%);height:calc(80%);margin:10%'></img>",
        ],
        rarePetEffects: [[new Decimal(1), new Decimal(1),]],

        petPoints: new Decimal(0),
        rarePetPointBase: [new Decimal(1),],
        rarePetButtonTimersMax: [new Decimal(60)],
        rarePetButtonTimers: [new Decimal(0)],
    }
    },
    automate() {
    },
    ...
    update(delta) {
        ...
        player.cb.buttonBaseXP = [new Decimal(1),new Decimal(2),new Decimal(4),new Decimal(0.06),new Decimal(25),]
        ...
        player.cb.buttonTimersMax = [new Decimal(60),new Decimal(180),new Decimal(300),new Decimal(5),new Decimal(1200),]
        ...
        player.cb.commonPetEffects = [
            ...
            [player.cb.commonPetLevels[2].pow(2.7).add(1), player.cb.commonPetLevels[2].pow(1.8).add(1),],
        ...
        player.cb.rarePetButtonTimersMax = [new Decimal(60)]
        ...
        player.cb.rarePetPointBase = [new Decimal(1)]
    ...
    clickables: {
        ...
        103: {
            ...
            unlocked() { return true },
            tooltip() { return player.cb.commonPetAmounts[2].gt(0) || player.cb.commonPetLevels[2].gt(0) ? "<h3>x" + format(player.cb.commonPetEffects[2][0]) + " to factor power.<br>x" + format(player.cb.commonPetEffects[2][1]) + " to mod gain.": ""},
            onClick() {
    ...
    microtabs: {
        ...
        ["raw-html", function () { return player.cb.rarePetDisplay[player.cb.rarePetDisplayIndex] }, { "color": "white", "font-size": "24px", "font-family": "monospace" }],
                    ["blank", "25px"],
                    ["row", [["clickable", 124], ["clickable", 18], ["clickable", 125]]],
                    ["blank", "25px"],
